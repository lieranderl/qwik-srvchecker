...
export const AdminConnectivity = component$<ConnectivityProps>(({ connectivity }) => {
          ...
          <tbody>
            {connectivity.map((data) => (
              <tr key={data.Ip}>
                <td>{data.Fqdn}</td>
                <td>{data.Ip}</td>
                <ConnectivityPortCell ports={data.Ports.filter(filter_admin)} />
                <ConnectivityPortCell ports={data.Ports.filter(filter_traversal)} />
              </tr>
            ))}
          </tbody>
        </table>
